  ...
  return (
    <div className="bg-white text-gray-900 font-[Inter,sans-serif] max-h-3/5">
      <main className="p-6 max-w-[1200px] mx-auto">
        <h2 className="text-xl font-bold text-[#2B2B2B] mb-4">Dashboard</h2>
          ...
          <div className="flex-1 bg-white rounded-xl p-6 shadow-[0_0_10px_#E6E6E6] max-w-full">
            ...
            <div className="flex justify-center mt-4 gap-6 text-xs text-gray-500">
              <div className="flex items-center gap-2">
                <span
                  aria-hidden="true"
                  className="w-3 h-3 rounded-full bg-[#4B6CB7] inline-block"
                ></span>
                Transactional SMS
              </div>
              <div className="flex items-center gap-2">
                <span
                  aria-hidden="true"
                  className="w-3 h-3 rounded-full bg-[#D9D9D9] inline-block"
                ></span>
                Promotional SMS
              </div>
            </div>
