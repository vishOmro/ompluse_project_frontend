          ...
          <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl">
            <div className="flex gap-6 mb-6 flex-wrap">
              <div className="flex flex-col flex-1 min-w-[140px]">
                ...
                <input
                  ...
                  required
                  className="rounded-lg bg-white border border-transparent focus:ring-indigo-400 focus:ring-2  px-4 py-2 text-sm text-gray-900 placeholder-gray-300 outline-none transition ring-1 ring-blue-400"
                />
              </div>
              ...
              {[
                ...
                <div key={field.id}>
                  ...
                  <input
                    ...
                    className="w-full border bg-white border-gray-200 rounded-md px-4 py-2 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 ring-1 ring-blue-400"
                    required
                  />
                </div>
              ))}
            ...
            <div>
              ...
              <textarea
                ...
                className="w-99 ring-1 ring-blue-400 bg-white border border-gray-200 rounded-md px-4 py-2 text-sm placeholder-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-indigo-400"
              />
            </div>
            ...
            <button
              ...
              className=" h-10 min-w-[140px] p-2 cursor-pointer rounded-xl bg-indigo-500 hover:bg-blue-600 transition flex items-center justify-center text-white text-lg"
            >
              Sign Up
            </button>
          </form>
          <p className="mt-6 text-sm text-gray-700 select-none max-w-xs">
            Already registred company?{" "}
            <Link
              href="/auth/login_company"
